...
export function parseFormattedToEpochMilliSecond(time: string, formatFrom: string, timezone: string = 'utc') {
...
export function epochMilliSecondsToFormatted(time: number, format?: string, timezone: string = 'utc') {
    const vtlFormatConverted = vtlToMomentFormat(format);
